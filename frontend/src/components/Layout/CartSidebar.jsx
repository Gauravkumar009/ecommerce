            ...
            <>
              ...
              <div className="space-y-4 mb-6">
                {cart &&
                  cart.map((item) => {
                    ...
                    return (
                      <div key={productId} className="glass-card p-4">
              ...
              <div className="border-t border-[hsla(var(--glass-border))] pt-4">
                ...
                <Link
                  to={"/cart"}
                  onClick={() => dispatch(toggleCart())}
                  className="w-full block text-center gradient-primary text-primary-foreground py-3 rounded-lg hover:glow-on-hover animate-smooth font-semibold"
                >
                  View Cart & Checkout
                </Link>
              </div>
