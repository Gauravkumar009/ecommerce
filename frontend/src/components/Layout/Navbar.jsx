...
const Navbar = () => {
  const { thene, toggleTheme } = useTheme();
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <button
            ...
            className="p-2 rounde-lg hover:bg-secondary transition-colors"
          >
          ...
          <div className="flex items-center space-x-2">
            ...
            {/* CART */}
             <button
              ...
              className="relativep-2 rounded-lg hover:bg-secondary transition-colors"
            >
